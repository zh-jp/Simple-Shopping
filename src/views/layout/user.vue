<template>
  <div class="user">
    <div class="head-page" v-if="isLogin()">
      <div class="head-img"><img src="@/assets/default-avatar.png" /></div>
      <div class="info">
        <div class="mobile">{{ detail.mobile }}</div>
        <div class="vip"><van-icon name="diamond-o" />普通用户</div>
      </div>
    </div>
...
.head-page {
  height: 130px;
  background-color: url("http://cba.itlike.com/public/mweb/static/background/user-header2.png");
